...
export default async function Image() {
  ...
  return new ImageResponse(
    (
      ...
      <div tw='text-xl bg-white w-full h-full flex justify-center items-center gap-y-2 p-2 font-inter font-semibold'>
        <h1 tw='text-2xl font-inter font-bold'>About VVGC</h1>
        <h2 tw='text-xl font-inter font-semibold max-w-96'>
            Our Mission
        </h2>
        <h3 tw='text-xl font-inter max-w-96'>
