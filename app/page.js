...
export default async function Home() {
  ...
  return (
    <React.Fragment>
      <section className={`h-[45dvh] sm:h-[70dvh] mx-auto w-full bg-hero-pattern bg-center bg-no-repeat bg-cover flex justify-center items-center  text-3xl md:text-6xl text-white font-sans font-[300] bg-opacity-70`}>
        <div className="w-[200px] md:w-[280px] h-auto align-middle text-center"><h1>A Home For Hindu Devotees</h1></div>
      </section>
      <main>
        {
          <div className="flex flex-col w-full h-auto shadow-md px-2 relative">
            {data.content.map((data, index) => (
              ...
              data.homepage === 'sponsor' ? < section key={index} className="bg-white flex flex-col w-full sm:w-full md:w-[800px] m-auto h-auto my-2 md:border-[1px] md:border-black md:p-10 " >
