...
export default async function RegularEventPage() {
  ...
  return (
    <>
      {/* Hero Banner */}
      <div
        className={`flex justify-center relative items-center w-full h-[75svh] text-3xl leading-9 text-white bg-center bg-no-repeat bg-cover 
      ...
      <main className="mx-auto   bg-neutral-100">
        {/* events */}
          ...
          <Card className="flex flex-col w-full lg:w-[900px] my-5 mx-auto">
            ...
            <CardContent className="w-full p-2 h-auto min-h-[100%] md:h-60 md:grid grid-cols-3 rounded border-slate-400 border-solid shadow-inner">
              <div className=" h-36 sm:min-h-48 col-span-1 flex flex-col justify-center items-center">
                <Link
                  href="https://www.youtube.com/@vaidicavidhyaganapathicent2187/streams"
                  target="_blank"
                >
