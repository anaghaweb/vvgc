...
export default function Dasara_2025() {
  return (
    <div className={
      ...
      <div className={`max-w-7xl w-full`}>
        ...
        <div className="text-left md:text-center space-y-4">
          {/* Main Heading */}
          <h2 className="text-2xl md:text-3xl font-bold text-orange-700">
              Dussera & Vijaya Dashami Celebrations
            </h2>
        ...
        <div className="space-y-6 text-gray-700">
          <div className="flex flex-col items-center xl:flex-row gap-6">
            ...
            <Link
              ...
              target="_blank"
              href="https://res.cloudinary.com/dixkqgqsi/image/upload/v1757855271/vvgc/images/2025/september/dasara2025.jpg"
            >
              <Image
                src="https://res.cloudinary.com/dixkqgqsi/image/upload/v1757855271/vvgc/images/2025/september/dasara2025.jpg"
