...
export default function Footer() {
  ...
  return (
   !campaign && <footer className="w-full max-w-full grid gap-2 grid-cols-1 md:grid-cols-2 xl:grid-cols-5  bg-sky-950 max-h-full h-auto items-center justify-center px-4 py-4">
