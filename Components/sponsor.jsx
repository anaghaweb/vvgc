    ...
    return (
        ...
        <section key={index} className={`bg-gray-50 w-full md:w-[600px] 
            ${playfair.variable} h-auto my-2 md:shadow-lg md:rounded md:p-2 mx-auto`}>
                ...
                <div className="flex w-full items-center bg-green-50"><h1 className=" text-base md:text-xl text-indigo-950 px-2">Sponsor this event </h1> <FaExternalLinkAlt style={{color:'indigo'}} /></div>              
