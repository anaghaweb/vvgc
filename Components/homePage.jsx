...
export default async function HomePage() {
  ...
  return (
    <React.Fragment>
      ...
      <main
        className={`${cormorant.variable} flex flex-col max-w-screen overflow-hidden h-auto from-gray-100 via-blue-100 to-slate-100`}
      >
        ...
        <Card className="w-[100%] h-auto md:p-10">
          ...
          <CardFooter>
            <Button className="flex w-full sm:w-44 mx-auto p-6 my-1 items-center text-white bg-green-700">
              <Link href="/events/regular">View Regular Events</Link>
            </Button>
          </CardFooter>
        </Card>
        <Card
