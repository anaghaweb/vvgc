...
export default function Footer() {
    return (
        <footer className="w-full max-w-screen grid gap-2 grid-cols-1 md:grid-cols-5 text-white bg-sky-950 h-auto md:h-[275px] items-center justify-center px-4 py-4">
            <section className='grid grid-cols-3 w-[200px]'>
