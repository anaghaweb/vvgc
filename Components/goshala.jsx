...
export default function Goshala() {
  ...
  return (
    <React.Fragment>
      ...
      <main className={`${cormorant.variable} mx-auto w-full max-w-full md:mt-4`}>
        <div
          className={`grid relative grid-cols-1 max-w-full h-auto bg-white mx-auto  md:grid-cols-4 md:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)] md:[filter:drop-shadow(0_10px_8px_rgb(0_0_0_/_0.04))_drop-shadow(0_4px_3px_rgb(0_0_0_/_0.1))] lg:w-[90%] ${opensans.variable}`}
        >
          <div
            className={`flex flex-col justify-items-center items-center w-full max-w-full text-center font[opensans] col-span-2 p-6`}
          >
            <h1
              className={`text-3xl leading-8  font-[cormorant] font-medium py:2 `}
            >
            ...
            <h3
              className={`leading-8 my-2 text-justify py:2`}
            >
          ...
          <div
            className={`relative col-span-1 w-72 h-72 sm:min-w-full sm:h-auto md:col-span-2 mx-auto object-cover`}
          >
            <Image
              src={go_dhanam_img}
              alt="Support Us"
        ...
        <div
          className={`grid relative grid-cols-1 max-w-full bg-white mx-auto  p-5 md:grid-cols-4 md:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)] md:[filter:drop-shadow(0_10px_8px_rgb(0_0_0_/_0.04))_drop-shadow(0_4px_3px_rgb(0_0_0_/_0.1))] lg:w-[90%] ${opensans.variable}`}
        >
          <div
            className={`flex flex-col justify-items-center items-center gap-5 w-full max-w-full text-center font[opensans] col-span-2 p-6`}
          >
            <div className=" flex flex-col gap-4 mx-auto min-h-fit md:h-56 items-center justify-around">
              <h2 className="text-lg  my-2 text-justify">
              To learn more about our programs and how you can support them, please visit
