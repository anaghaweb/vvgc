...
export default function Goshala() {
    ...
    return (
        <React.Fragment>
            ...
            >
                <h1 className="text-[1.9rem] md:text-[4.5rem] font-[cormorant]">VVGC Goshala</h1>
            </div>
            {/* main section */}
            ...
            <main className={`${cormorant.variable} mx-auto w-full max-w-full`}>
                ...
                <div className={`grid relative grid-cols-1 max-w-full h-auto bg-white mx-auto my-5 p-5 md:grid-cols-4 md:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)] md:[filter:drop-shadow(0_10px_8px_rgb(0_0_0_/_0.04))_drop-shadow(0_4px_3px_rgb(0_0_0_/_0.1))] lg:w-[90%] ${opensans.variable}`}>
                    <div className={`flex flex-col justify-items-center items-center w-full max-w-full text-center font[opensans] col-span-2 p-6`}>
                        ...
                        <h3 className={`leading-8 my-2 md:text-xl text-justify   py:2 md:py-5`}>
                ...
                <div className={`grid relative grid-cols-1 max-w-full bg-white mx-auto  p-5 md:grid-cols-4 md:shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-2px_rgba(0,0,0,0.05)] md:[filter:drop-shadow(0_10px_8px_rgb(0_0_0_/_0.04))_drop-shadow(0_4px_3px_rgb(0_0_0_/_0.1))] lg:w-[90%] ${opensans.variable}`}>

                    <div className={`flex flex-col justify-items-center items-center gap-5 w-full max-w-full text-center font[opensans] col-span-2 p-6`}>
                       

                        <div className=" flex flex-col gap-4 mx-auto min-h-fit md:h-56 items-center justify-around">
                            <h3 className=" text-base md:text-2xl my-2 text-justify">
                            ...
                            ><Link  
                            href="https://paybee.io/quickpay.html?handle=vvgc&ppid=8#optionList" target="_blank">Click here </Link></Button>
                        </div>
                    ...
                    <div className={`relative col-span-1 w-full max-w-full h-72 md:col-span-2`}>
                        <Image src={'/goshala/goshala-2.jpg'} alt="Support Us" fill quality={75} sizes={'100vw'}
                            className="object-contain m-auto absolute" />
